/****************************************************************************
** Meta object code from reading C++ file 'triangle.hpp'
**
...
#error "The header file 'triangle.hpp' doesn't include <QObject>."
...
const QMetaObject Triangle::staticMetaObject = {
    { &Figure::staticMetaObject, qt_meta_stringdata_Triangle.data,
      qt_meta_data_Triangle,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
