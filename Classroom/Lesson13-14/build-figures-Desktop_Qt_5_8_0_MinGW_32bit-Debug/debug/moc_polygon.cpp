/****************************************************************************
** Meta object code from reading C++ file 'polygon.hpp'
**
...
#error "The header file 'polygon.hpp' doesn't include <QObject>."
...
const QMetaObject Polygon::staticMetaObject = {
    { &Figure::staticMetaObject, qt_meta_stringdata_Polygon.data,
      qt_meta_data_Polygon,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Polygon::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Polygon.stringdata0))
        return static_cast<void*>(const_cast< Polygon*>(this));
